...
export default function ProfileCardBig({ imageSrc, name, description, phone, email, gyms }: TrainerProps) {
    return <>
        ...
        <section className="mt-8 bg-white flex p-8 rounded-2xl gap-x-24 shadow-dark">
            ...
            <div className='flex font-inter flex-col'>
                ...
                <span className='font-light text-[30px] leading-[32px] mt-16'>{description}</span>
