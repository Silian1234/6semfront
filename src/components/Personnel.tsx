...
export default function Personnel() {
    return <article className="mt-16">
        ...
        <section className="flex justify-between w-full flex-wrap mt-8">
            <TrainerCard imageSrc={Photo1} name="Генадин Леонид Васильевич" description={["Заслуженный тренер России", "Призер чемпионата мира 2029"]} />
            <TrainerCard imageSrc={Photo2} name="Викторина Анна Геннадьевна" description={["Заслуженный тренер России", "Призер чемпионата мира 2079"]} />
        </section>
    </article>
}